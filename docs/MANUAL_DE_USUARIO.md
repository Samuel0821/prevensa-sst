### **Manual de Usuario de la Plataforma Prevensap**

¡Bienvenido a Prevensap! Esta guía te ayudará a utilizar nuestras herramientas para gestionar la Seguridad y Salud en el Trabajo de manera eficiente. La plataforma se divide en dos componentes principales:

1.  **La Aplicación Web:** Diseñada para administradores y supervisores. Se accede desde una computadora y permite una gestión completa de la información.
2.  **La Aplicación Móvil:** Diseñada para los trabajadores en campo. Permite reportar y consultar información de forma rápida y sencilla desde un teléfono.

---

### **Sección 1: Acceso a la Plataforma**

#### **1.1. Aplicación Web (Para Administradores)**
...
Tanto en la web como en la app móvil, la primera pantalla que verás es la de inicio de sesión.

*   **Credenciales:** Deberás usar el **email** y la **contraseña** que te fueron asignados por el administrador del sistema.
*   **Roles:** Dependiendo de tus credenciales, la plataforma te dará acceso como `Administrador` o como `Usuario`, cada uno con diferentes permisos.
